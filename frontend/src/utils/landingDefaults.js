...
export function getLandingDefaults() {
  return {
    ...
    gallery: [
      { id: 0, title: 'Grand Marriage Hall', category: 'MARRIAGE_HALL', category_label: 'Marriage Hall', image_url: null, sort_order: 0 },
      { id: 1, title: 'Royal Wedding Stage', category: 'WEDDING_STAGE', category_label: 'Wedding Stage', image_url: null, sort_order: 1 },
      { id: 2, title: 'Deluxe Guest Room', category: 'GUEST_ROOM', category_label: 'Guest Room', image_url: null, sort_order: 2 },
      { id: 3, title: 'Fine Dining Area', category: 'DINING', category_label: 'Dining Area', image_url: null, sort_order: 3 },
      { id: 4, title: 'Elegant Reception', category: 'RECEPTION', category_label: 'Reception Area', image_url: null, sort_order: 4 },
      { id: 5, title: 'Outdoor Event Lawn', category: 'OUTDOOR', category_label: 'Outdoor Event Area', image_url: null, sort_order: 5 },
    ],
    testimonials: [
      {
        id: 0,
