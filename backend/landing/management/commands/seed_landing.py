...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        if HeroSlide.objects.exists():
            ...
            self.stdout.write(self.style.SUCCESS('Hero slide seeded.'))

        if GalleryImage.objects.exists():
            self.stdout.write('Gallery images already exist - skipping gallery seed.')
        else:
        ...
        if LandingStatistic.objects.exists():
            self.stdout.write('Landing statistics already exist - skipping stats seed.')
        else:
            stats = [
            ...
            self.stdout.write(self.style.SUCCESS('Landing statistics seeded.'))

        if LandingFAQ.objects.exists():
            self.stdout.write('FAQs already exist - skipping FAQ seed.')
        else:
            faqs = [
