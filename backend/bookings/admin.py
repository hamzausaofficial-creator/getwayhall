...
class MarriageHallPageMaintenanceInline(admin.TabularInline):
    ...
    verbose_name = 'Page'
    verbose_name_plural = (
        'Marriage Hall — <strong>Maintenance mode</strong>: tick to show “Under maintenance” screen'
    )
...
class MarriageHallPageMaintenanceAdmin(_HallPageAdminBase):
    ...
    list_display = ('label', 'page_key', 'tenant', 'maintenance_badge', 'in_maintenance')
    ...
    fieldsets = (
        (None, {
            ...
            'description': (
                ...
                'when users open this page. The page can stay visible in the menu.'
            ),
        }),
    )
